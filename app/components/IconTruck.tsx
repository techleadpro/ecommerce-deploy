		...
		<div>
			<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
				<g fill="none" stroke="currentColor" strokeWidth="1">
					...
					<path strokeLinecap="round" d="M6 9v2" />
				</g>
			</svg>
		</div>
	)
